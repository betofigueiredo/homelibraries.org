...
/**
 * @render react
 * @name CDEmailsContainer
 * @description Container para a url /create/doc/emails
 * @example
 */
...
import CDEmails from './CDEmails';

// Functions
import { _post } from '../../../functions/_requests';

class CDEmailsContainer extends Component {
	constructor(props) {
		super(props);
		this.state = {
			saving: 0,
...
const _CDEmailsContainer = connect(mapStateToProps, mapDispatchToProps)(CDEmailsContainer);
export default CDHoc(_CDEmailsContainer);
